...
import { AccountModel, AuthenticationModel, HashComparer, LoadAccountByEmailRepository, Encrypter, UpdateAccesTokenRepository } from './db-authentication-protocols'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new DbAuthentication(loadAccountByEmailRepositoryStub,
    hashComparerStub, encrypterStub, updateAccessTokenRepository)
  return {
    sut,
...
describe('DbAuthentication UseCase', () => {
  ...
  test('Should call Encrypter and return a valid token', async () => {
    const { sut } = makeSut()
